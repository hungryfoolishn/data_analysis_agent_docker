...
class EvaluationRun(BaseModel):
    ...
    by_skill_id: dict[str, float] = Field(default_factory=dict)
    by_skill_version: dict[str, float] = Field(default_factory=dict)
    by_skill_hash: dict[str, float] = Field(default_factory=dict)
